...
<img src="docs/logo_tc.png" width="280" alt="Armello"/>
...
此 bug 存在於遊戲引擎本身（Unity 2019.4 / NGUI / IL2CPP），官方版本同樣會觸發——只是官方中文的文字長度恰好多數不在觸發區。任何修改遊戲文字導致描述長度變化的 mod 都可能觸發此問題。
...
本補丁的調研、根因分析、原始碼反編譯解讀、Harmony 補丁編寫與除錯工作由 **AI（大語言模型）** 完成，人類角色為需求提出、方向決策、遊戲內測試與最終驗收。
